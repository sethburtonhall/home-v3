...
{/*       <h1 className="mb-6 w-full text-center text-4xl md:text-5xl">
      ...
      <p className="text-lg md:text-xl">
        Lead Frontend Developer working in composable. Creative Producer living in sabbatical. Digital Nomad. Journeyman. Over 25 years of experience in creative collaboration. You can find me online at{' '}
        <a
