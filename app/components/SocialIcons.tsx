...
export default function SocialIcons() {
  return (
    <div className="order-2 flex w-[250px] justify-center md:justify-start md:items-start md:order-1 md:mb-0">
      <a
      ...
      >
        ...
        <svg fill="currentColor" viewBox="0 0 24 24" width={25} height={17}>
          <path
            fillRule="evenodd"
      ...
      {/* <a
        ...
        target="_blank"
        rel="noopener"
        className="social-icon mb-[-3px] font-sans text-lg font-bold"
        title="Dev.to"
      >
        DEV
      </a> */}
